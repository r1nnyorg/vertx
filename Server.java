public class Server
{
    public static void main(final java.lang.String[] args)
    {
        ...
        final var database = io.vertx.pgclient.PgPool.pool(vertx, new io.vertx.pgclient.PgConnectOptions().setHost("cockroach").setDatabase("defaultdb").setUser("root").setSslMode(io.vertx.pgclient.SslMode.VERIFY_FULL).setPemKeyCertOptions(new io.vertx.core.net.PemKeyCertOptions().addCertPath("client.root.crt").addKeyPath("client.root.key")).setPort(26257), new io.vertx.sqlclient.PoolOptions());
