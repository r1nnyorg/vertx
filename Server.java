public class Server
{
    public static void main(final java.lang.String[] args)
    {
        ...
        final var database = io.vertx.pgclient.PgPool.pool(vertx, new io.vertx.pgclient.PgConnectOptions().setHost("cockroach").setDatabase("defaultdb").setUser("root").setSsl(true), new io.vertx.sqlclient.PoolOptions());
