public class Server
{
	...
	final var haha = new org.springframework.core.ParameterizedTypeReference<java.util.HashMap<java.lang.String, java.lang.Object>>(){};
	final var route = org.springframework.web.reactive.function.server.RouterFunctions.route(org.springframework.web.reactive.function.server.RequestPredicates.GET("/"), request -> org.springframework.web.reactive.function.server.ServerResponse.ok().body(org.springframework.web.reactive.function.BodyInserters.fromPublisher(client.sql("select * from productItem").fetch().all(), haha)));
