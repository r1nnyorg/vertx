public class Server
{
    public static void main(final java.lang.String[] args)
    {
        ...
        final var client = io.vertx.redis.client.Redis.createClient(vertx, new io.vertx.redis.client.RedisOptions().setType(io.vertx.redis.client.RedisClientType.CLUSTER).addConnectionString("redis://redis").setPassword(java.lang.System.getenv("password")));
